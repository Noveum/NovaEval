...
class TestNoveumSpansPreprocessing:
    ...
    def test_both_parameters_provided_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Provide either json_dir or json_files, but not both"):
    ...
    def test_no_json_files_in_directory_raises_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with pytest.raises(ValueError, match="No JSON files found in the directory"):
                noveum_spans_preprocessing(json_dir=temp_dir)
    ...
    def test_json_file_not_found_continues(self, mock_exists, mock_file):
        ...
        try:
            ...
            noveum_spans_preprocessing(json_files=["test.json"], output_csv=temp_csv_path)
        finally:
    ...
    def test_invalid_json_continues(self, mock_exists, mock_open_func):
        ...
        mock_exists.return_value = True
        mock_open_func.return_value.__enter__.return_value.read.return_value = "invalid json"
