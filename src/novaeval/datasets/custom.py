...
class CustomDataset(BaseDataset):
    ...
    def _convert_sample(self, item: Dict[str, Any], index: int) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            sample = {
                ...
                "metadata": {
                    ...
                    "source": str(self.data_source) if isinstance(self.data_source, (str, Path)) else "programmatic",
                }
            }
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        info = super().get_info()
        info.update({
            "data_source": str(self.data_source) if isinstance(self.data_source, (str, Path)) else "programmatic",
