...
class TracesQueryParams(BaseModel):
    ...
    start_time: Optional[str] = Field(None, description="Start time filter (ISO datetime)")
    ...
    include_spans: Optional[bool] = Field(False, description="Whether to include spans in response")
    ...
    def to_query_params(self) -> dict:
        ...
        for field_name, field_value in self.model_dump(exclude_none=True, exclude={"from_"}).items():
...
class DatasetCreateRequest(BaseModel):
    ...
    slug: Optional[str] = Field(None, description="Dataset slug (auto-generated if not provided)")
    description: Optional[str] = Field(None, description="Dataset description")
    visibility: Literal["public", "org", "private"] = Field("org", description="Dataset visibility")
    dataset_type: Literal["agent", "conversational", "g-eval", "custom"] = Field("custom", description="Dataset type")
...
class DatasetUpdateRequest(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Dataset description")
    visibility: Optional[Literal["public", "org", "private"]] = Field(None, description="Dataset visibility")
    dataset_type: Optional[Literal["agent", "conversational", "g-eval", "custom"]] = Field(None, description="Dataset type")
    environment: Optional[str] = Field(None, description="Environment")
    schema_version: Optional[str] = Field(None, description="Schema version")
    tags: Optional[List[str]] = Field(None, description="Dataset tags")
    custom_attributes: Optional[Dict[str, Any]] = Field(None, description="Custom attributes")
...
class DatasetsQueryParams(BaseModel):
    ...
    limit: Optional[int] = Field(20, ge=1, le=1000, description="Number of datasets to return")
    offset: Optional[int] = Field(0, ge=0, description="Number of datasets to skip")
    visibility: Optional[Literal["public", "org", "private"]] = Field(None, description="Filter by visibility")
    organizationSlug: Optional[str] = Field(None, description="Filter by organization slug")
    includeVersions: Optional[bool] = Field(False, description="Include dataset versions")
...
class DatasetItemsCreateRequest(BaseModel):
    ...
    items: List[DatasetItem] = Field(..., min_items=1, description="Items to add")
...
class ScorerResultCreateRequest(BaseModel):
    ...
    details: Optional[Dict[str, Any]] = Field(None, description="Detailed scoring information")
...
class ScorerResultsBatchRequest(BaseModel):
    ...
    results: List[ScorerResultCreateRequest] = Field(..., min_items=1, description="Results to create")
