...
def create_agent_trajectories():
    pass

def swe_agent_trajectories_preprocessing(parquet_dir: str = None, parquet_files: list = None, output_csv: str = "output.csv") -> None:
    """
    ...
    """
    if (parquet_dir is not None and parquet_files is not None) or (parquet_dir is None and parquet_files is None):
