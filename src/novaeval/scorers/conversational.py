...
class Conversation(BaseModel):
    ...
    context: Optional[str] = Field(default=None, description="Conversation context or system prompt")
        ...
        **kwargs
        ...
        try:
            ...
            return ScoreResult(
                score=0.0,
                passed=False,
                reasoning=f"Knowledge retention evaluation failed: {str(e)}",
    ...
    async def evaluate(
        ...
        **kwargs
        ...
        try:
            ...
            completeness_score, reasoning = self._parse_completeness_score(completeness_response)
            ...
            return ScoreResult(
                score=0.0,
                passed=False,
                reasoning=f"Conversation completeness evaluation failed: {str(e)}",
                metadata={"error": str(e)}
            )
        ...
        **kwargs
        ...
        try:
            ...
            return ScoreResult(
                score=0.0,
                passed=False,
                reasoning=f"Conversation relevancy evaluation failed: {str(e)}",
                metadata={"error": str(e)}
            )
    ...
    async def evaluate(
        ...
        **kwargs
        ...
        try:
            ...
            ai_responses = [
                turn.message for turn in conversation.turns 
            ...
            return ScoreResult(
                score=0.0,
                passed=False,
                reasoning=f"Role adherence evaluation failed: {str(e)}",
                metadata={"error": str(e)}
            )
        ...
        try:
            ...
            results = await asyncio.gather(
                self.knowledge_retention_scorer.evaluate(
                    input_text, output_text, expected_output, context, conversation=conversation
                ),
            ...
            metric_names = ["knowledge_retention", "completeness", "relevancy", "role_adherence"]
            ...
            return ScoreResult(
                ...
                metadata={
                    ...
                    "conversation_stats": {
                        ...
                        "ai_responses": len([t for t in conversation.turns if t.speaker.lower() in ['assistant', 'ai', 'bot']]),
                        "user_messages": len([t for t in conversation.turns if t.speaker.lower() == 'user'])
                    }
                }
            )
            ...
            return ScoreResult(
                score=0.0,
                passed=False,
                reasoning=f"Conversational metrics evaluation failed: {str(e)}",
                metadata={"error": str(e)}
            )
