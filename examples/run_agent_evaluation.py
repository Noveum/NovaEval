...
from examples.agent_evaluation_clean import main as run_evaluation
...
def main():
    ...
    original_output_file = getattr(eval_module, 'DEFAULT_OUTPUT_FILE', 'agent_scores_with_reasoning.csv')
