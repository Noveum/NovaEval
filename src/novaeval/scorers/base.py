...
class BaseScorer(ABC):
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_score": self.score_sum / self.total_scores if self.total_scores > 0 else 0.0,
            "config": self.kwargs,
        }
        ...
        for score in self.scores_history:
            if isinstance(score, dict):
                ...
                if "score" in score:
                    ...
                    numeric_scores.append(list(score.values())[0])
            else:
    ...
    def _track_score(self, score: Union[float, Dict[str, float]]) -> None:
        ...
        if isinstance(score, (int, float)):
            ...
            self.score_sum += float(list(score.values())[0])
